...
module.exports = {"paginationWrapper":"styles-m__paginationWrapper---2I6si","pagination":"styles-m__pagination---Cl6YE","hidden":"styles-m__hidden---2gcgq"};
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(6), __webpack_require__(30)(module)))
...
var _CSSTransition = _interopRequireDefault(__webpack_require__(32));

var _ReplaceTransition = _interopRequireDefault(__webpack_require__(39));

var _TransitionGroup = _interopRequireDefault(__webpack_require__(14));

var _Transition = _interopRequireDefault(__webpack_require__(11));
...
*/
var aa=__webpack_require__(0),p=__webpack_require__(10),ba=__webpack_require__(22);function ca(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[c,d,e,f,g,h],k=0;a=Error(b.replace(/%s/g,function(){return l[k++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var _addClass = _interopRequireDefault(__webpack_require__(35));

var _removeClass = _interopRequireDefault(__webpack_require__(38));
...
var _hasClass = _interopRequireDefault(__webpack_require__(37));
...
// CONCATENATED MODULE: ./source/bus/page/types.js
const types = {
  SET_PAGE: 'SET_PAGE'
};
// CONCATENATED MODULE: ./source/bus/page/reducer.js
...
const pageReducer = (state = initialState, action) => {
  switch (action.type) {
    case types.SET_PAGE:
      return fromJS(reducer_objectSpread({}, state.toJSON(), action.payload));

    default:
      return state;
  }
};
// CONCATENATED MODULE: ./source/bus/todos/types.js
const types_types = {
  // Sync
...
function todos_reducer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { todos_reducer_defineProperty(target, key, source[key]); }); } return target; }
...
const reducer_initialState = List();
const todosReducer = (state = reducer_initialState, action) => {
  switch (action.type) {
    case types_types.FETCH_TODOS:
      return fromJS(action.payload);

    case types_types.CREATE_TODO:
      return state.unshift(fromJS(action.payload.todo)).filter(todo => todo.get("message").indexOf(action.payload.search || '') !== -1).slice(0, action.payload.size);

    case types_types.UPDATE_TODO:
      return state.update(state.findIndex(todo => {
        return todo.get('id') === action.payload.id;
      }), todo => {
        return fromJS(todos_reducer_objectSpread({}, todo.toJSON(), action.payload));
      });

    case types_types.UPDATE_TODOS:
      return state.map(todo => {
        const todoJSON = todo.toJSON();
        const index = action.payload.findIndex(todoPayload => todoPayload.id === todoJSON.id);

        if (index !== -1) {
          return fromJS(todos_reducer_objectSpread({}, todoJSON, action.payload[index]));
        }

        return todo;
      });

    case types_types.UPDATE_ALL_TODOS:
      return state.map(todo => fromJS(todos_reducer_objectSpread({}, todo.toJSON(), action.payload)));

    case types_types.REMOVE_TODO:
      return state.filter(todo => todo.get("id") !== action.payload.todoId);

    default:
      return state;
  }
};
// CONCATENATED MODULE: ./source/bus/ui/types.js
const ui_types_types = {
...
const ui_reducer_initialState = Map({
  isFetching: false
});
const uiReducer = (state = ui_reducer_initialState, action) => {
  switch (action.type) {
    case ui_types_types.START_FETCHING:
      return state.set("isFetching", true);

    case ui_types_types.STOP_FETCHING:
...
// CONCATENATED MODULE: ./source/bus/page/actions.js
// Types
...
const todosActions = {
  ...
  fetchTodos: todos => {
    return {
      type: types_types.FETCH_TODOS,
      payload: todos
    };
  },
  createTodo: todo => {
    return {
      type: types_types.CREATE_TODO,
      payload: todo
    };
  },
  updateTodo: todo => {
    return {
      type: types_types.UPDATE_TODO,
      payload: todo
    };
  },
  updateTodos: todos => {
    return {
      type: types_types.UPDATE_TODOS,
      payload: todos
    };
  },
  updateAllTodos: todo => {
    return {
      type: types_types.UPDATE_ALL_TODOS,
      payload: todo
    };
  },
  removeTodo: todoId => {
    return {
      type: types_types.REMOVE_TODO,
      payload: todoId
    };
  },
  // Async
  fetchTodosAsync: queryParams => {
    return {
      type: types_types.FETCH_TODOS_ASYNC,
      payload: queryParams
    };
  },
  createTodoAsync: message => {
    return {
      type: types_types.CREATE_TODO_ASYNC,
      payload: message
    };
  },
  updateTodoAsync: todo => {
    return {
      type: types_types.UPDATE_TODO_ASYNC,
      payload: todo
    };
  },
  removeTodoAsync: todoId => {
    return {
      type: types_types.REMOVE_TODO_ASYNC,
      payload: todoId
    };
  }
};
...
const uiActions = {
  startFetching: () => {
    return {
      type: ui_types_types.START_FETCHING
    };
  },
  stopFetching: () => {
    return {
      type: ui_types_types.STOP_FETCHING
    };
  },
  emitError: (error, meta = null) => {
    return {
      type: ui_types_types.EMIT_ERROR,
      payload: error,
      error: true,
      meta
    };
...
// CONCATENATED MODULE: ./source/bus/todos/saga/workers/fetchTodos.js
// Core
 // Instruments
...
function* fetchTodos({
  ...
  try {
    yield Object.defineProperty(io_put(uiActions.startFetching()), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\fetchTodos.js",
        lineNumber: 12,
        code: "put(uiActions.startFetching())"
      }
    });
    const response = yield Object.defineProperty(apply(api, api.todos.fetch, [page, size, search]), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\fetchTodos.js",
        lineNumber: 14,
        code: "apply(api, api.todos.fetch, [page, size, search])"
      }
    });
    const {
      data: todos,
    ...
    yield Object.defineProperty(io_put(todosActions.fetchTodos(todos)), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\fetchTodos.js",
        lineNumber: 21,
        code: "put(todosActions.fetchTodos(todos))"
      }
    });
    yield Object.defineProperty(io_put(pageActions.setPage(meta)), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\fetchTodos.js",
        lineNumber: 22,
        code: "put(pageActions.setPage(meta))"
      }
    });
  } catch (error) {
    yield Object.defineProperty(io_put(uiActions.emitError(error, 'fetchTodos worker')), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\fetchTodos.js",
        lineNumber: 24,
        code: "put(uiActions.emitError(error, 'fetchTodos worker'))"
      }
    });
  } finally {
    yield Object.defineProperty(io_put(uiActions.stopFetching()), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\fetchTodos.js",
        lineNumber: 26,
        code: "put(uiActions.stopFetching())"
      }
    });
  }
}
Object.defineProperty(fetchTodos, "@@redux-saga/LOCATION", {
  value: {
    fileName: "source\\bus\\todos\\saga\\workers\\fetchTodos.js",
    lineNumber: 10,
    code: null
...
// CONCATENATED MODULE: ./source/bus/todos/saga/workers/createTodo.js
// Core
 // Instruments
...
function* createTodo_createTodo({
  payload: todoMessage
}) {
  try {
    yield Object.defineProperty(io_put(uiActions.startFetching()), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\createTodo.js",
        lineNumber: 12,
        code: "put(uiActions.startFetching())"
      }
    });
    const response = yield Object.defineProperty(apply(api, api.todos.create, [todoMessage]), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\createTodo.js",
        lineNumber: 14,
        code: "apply(api, api.todos.create, [todoMessage])"
      }
    });
    const {
      data: todo,
    ...
    const page = yield Object.defineProperty(io_select(state => state.page.get('page')), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\createTodo.js",
        lineNumber: 21,
        code: "select((state) => state.page.get('page'))"
      }
    });
    const size = yield Object.defineProperty(io_select(state => state.page.get('size')), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\createTodo.js",
        lineNumber: 22,
        code: "select((state) => state.page.get('size'))"
      }
    });
    const total = yield Object.defineProperty(io_select(state => state.page.get('total')), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\createTodo.js",
        lineNumber: 23,
        code: "select((state) => state.page.get('total'))"
      }
    });
    const search = yield Object.defineProperty(io_select(state => state.page.get('search')), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\createTodo.js",
        lineNumber: 24,
        code: "select((state) => state.page.get('search'))"
      }
    });

    if (page === 1) {
      yield Object.defineProperty(io_put(todosActions.createTodo({
        todo,
        size,
        search
      })), "@@redux-saga/LOCATION", {
        value: {
          fileName: "source\\bus\\todos\\saga\\workers\\createTodo.js",
          lineNumber: 27,
          code: "put(todosActions.createTodo({ todo, size, search }))"
        }
      });
      yield Object.defineProperty(io_put(pageActions.setPage({
        total: total + 1
      })), "@@redux-saga/LOCATION", {
        value: {
          fileName: "source\\bus\\todos\\saga\\workers\\createTodo.js",
          lineNumber: 28,
          code: "put(pageActions.setPage({ total: total + 1 }))"
        }
      });
    } else {
      const fetchResponse = yield Object.defineProperty(apply(api, api.todos.fetch, [page, size, search]), "@@redux-saga/LOCATION", {
        value: {
          fileName: "source\\bus\\todos\\saga\\workers\\createTodo.js",
          lineNumber: 30,
          code: "apply(api, api.todos.fetch, [page, size, search])"
      ...
      const {
        ...
        fetchMessage,
        meta
      } = yield Object.defineProperty(apply(fetchResponse, fetchResponse.json), "@@redux-saga/LOCATION", {
        value: {
          fileName: "source\\bus\\todos\\saga\\workers\\createTodo.js",
          lineNumber: 31,
          code: "apply(fetchResponse, fetchResponse.json)"
        }
      });
    ...
    yield Object.defineProperty(io_put(uiActions.emitError(error, 'createTodo worker')), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\createTodo.js",
        lineNumber: 41,
        code: "put(uiActions.emitError(error, 'createTodo worker'))"
      }
    });
  } finally {
    yield Object.defineProperty(io_put(uiActions.stopFetching()), "@@redux-saga/LOCATION", {
...
Object.defineProperty(createTodo_createTodo, "@@redux-saga/LOCATION", {
  value: {
    fileName: "source\\bus\\todos\\saga\\workers\\createTodo.js",
    lineNumber: 10,
    code: null
...
// CONCATENATED MODULE: ./source/bus/todos/saga/workers/updateTodo.js
// Core
 // Instruments
...
function* updateTodo({
  ...
  try {
    yield Object.defineProperty(io_put(uiActions.startFetching()), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\updateTodo.js",
        lineNumber: 11,
        code: "put(uiActions.startFetching())"
      }
    });
    const response = yield Object.defineProperty(apply(api, api.todos.update, [todos]), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\updateTodo.js",
        lineNumber: 13,
        code: "apply(api, api.todos.update, [todos])"
      }
    });
    const {
      data: updatedTodos,
    ...
    yield Object.defineProperty(io_put(todosActions.updateTodos(updatedTodos)), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\updateTodo.js",
        lineNumber: 20,
        code: "put(todosActions.updateTodos(updatedTodos))"
      }
    });
  } catch (error) {
    yield Object.defineProperty(io_put(uiActions.emitError(error, 'updateTodo worker')), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\updateTodo.js",
        lineNumber: 22,
        code: "put(uiActions.emitError(error, 'updateTodo worker'))"
      }
    });
  } finally {
    yield Object.defineProperty(io_put(uiActions.stopFetching()), "@@redux-saga/LOCATION", {
...
Object.defineProperty(updateTodo, "@@redux-saga/LOCATION", {
  value: {
    fileName: "source\\bus\\todos\\saga\\workers\\updateTodo.js",
    lineNumber: 9,
    code: null
...
// CONCATENATED MODULE: ./source/bus/todos/saga/workers/removeTodo.js
// Core
 // Instruments
...
function* removeTodo({
  ...
  try {
    yield Object.defineProperty(io_put(uiActions.startFetching()), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\removeTodo.js",
        lineNumber: 12,
        code: "put(uiActions.startFetching())"
      }
    });
    const response = yield Object.defineProperty(apply(api, api.todos.remove, [todoId]), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\removeTodo.js",
        lineNumber: 14,
        code: "apply(api, api.todos.remove, [todoId])"
      }
    });
    ...
    if (page > 1 && page === pageLast) {
      if (total - (page - 1) * size > 1) {
        yield Object.defineProperty(io_put(todosActions.removeTodo({
          todoId
        })), "@@redux-saga/LOCATION", {
          value: {
            fileName: "source\\bus\\todos\\saga\\workers\\removeTodo.js",
            lineNumber: 31,
            code: "put(todosActions.removeTodo({ todoId }))"
          }
        });
        yield Object.defineProperty(io_put(pageActions.setPage({
          total: total - 1
        ...
        const fetchResponse = yield Object.defineProperty(apply(api, api.todos.fetch, [page - 1, size, search]), "@@redux-saga/LOCATION", {
          value: {
            fileName: "source\\bus\\todos\\saga\\workers\\removeTodo.js",
            lineNumber: 34,
            code: "apply(api, api.todos.fetch, [page - 1, size, search])"
          }
        });
        const {
          data: todos,
    ...
    yield Object.defineProperty(io_put(uiActions.emitError(error, 'removeTodo worker')), "@@redux-saga/LOCATION", {
      value: {
        fileName: "source\\bus\\todos\\saga\\workers\\removeTodo.js",
        lineNumber: 48,
        code: "put(uiActions.emitError(error, 'removeTodo worker'))"
      }
    });
  } finally {
    yield Object.defineProperty(io_put(uiActions.stopFetching()), "@@redux-saga/LOCATION", {
...
Object.defineProperty(removeTodo, "@@redux-saga/LOCATION", {
  value: {
    fileName: "source\\bus\\todos\\saga\\workers\\removeTodo.js",
    lineNumber: 10,
    code: null
...
// CONCATENATED MODULE: ./source/bus/todos/saga/workers/index.js




// CONCATENATED MODULE: ./source/bus/todos/saga/watchers.js
// Core
 // Types
...
function* watcherFetchTodos() {
  yield Object.defineProperty(io_helpers_takeEvery(types_types.FETCH_TODOS_ASYNC, fetchTodos), "@@redux-saga/LOCATION", {
    value: {
      fileName: "source\\bus\\todos\\saga\\watchers.js",
      lineNumber: 11,
      code: "takeEvery(types.FETCH_TODOS_ASYNC, fetchTodos)"
    }
  });
}
Object.defineProperty(watcherFetchTodos, "@@redux-saga/LOCATION", {
  value: {
    fileName: "source\\bus\\todos\\saga\\watchers.js",
    lineNumber: 10,
    code: null
...
function* watcherCreateTodo() {
  yield Object.defineProperty(io_helpers_takeEvery(types_types.CREATE_TODO_ASYNC, createTodo_createTodo), "@@redux-saga/LOCATION", {
    value: {
      fileName: "source\\bus\\todos\\saga\\watchers.js",
      lineNumber: 15,
      code: "takeEvery(types.CREATE_TODO_ASYNC, createTodo)"
    }
  });
}
Object.defineProperty(watcherCreateTodo, "@@redux-saga/LOCATION", {
  value: {
    fileName: "source\\bus\\todos\\saga\\watchers.js",
    lineNumber: 14,
    code: null
...
function* watcherUpdateTodo() {
  yield Object.defineProperty(io_helpers_takeEvery(types_types.UPDATE_TODO_ASYNC, updateTodo), "@@redux-saga/LOCATION", {
    value: {
      fileName: "source\\bus\\todos\\saga\\watchers.js",
      lineNumber: 19,
      code: "takeEvery(types.UPDATE_TODO_ASYNC, updateTodo)"
    }
  });
}
Object.defineProperty(watcherUpdateTodo, "@@redux-saga/LOCATION", {
  value: {
    fileName: "source\\bus\\todos\\saga\\watchers.js",
    lineNumber: 18,
    code: null
...
function* watcherRemoveTodo() {
  yield Object.defineProperty(io_helpers_takeEvery(types_types.REMOVE_TODO_ASYNC, removeTodo), "@@redux-saga/LOCATION", {
    value: {
      fileName: "source\\bus\\todos\\saga\\watchers.js",
      lineNumber: 23,
      code: "takeEvery(types.REMOVE_TODO_ASYNC, removeTodo)"
    }
  });
}
Object.defineProperty(watcherRemoveTodo, "@@redux-saga/LOCATION", {
  value: {
    fileName: "source\\bus\\todos\\saga\\watchers.js",
    lineNumber: 22,
    code: null
...
function* watchTodos() {
  yield Object.defineProperty(io_all([call(watcherFetchTodos), call(watcherCreateTodo), call(watcherUpdateTodo), call(watcherRemoveTodo)]), "@@redux-saga/LOCATION", {
    value: {
      fileName: "source\\bus\\todos\\saga\\watchers.js",
      lineNumber: 27,
...
Object.defineProperty(watchTodos, "@@redux-saga/LOCATION", {
  value: {
    fileName: "source\\bus\\todos\\saga\\watchers.js",
    lineNumber: 26,
    code: null
...
function* rootSaga() {
  yield Object.defineProperty(io_all([call(watchTodos)]), "@@redux-saga/LOCATION", {
    value: {
...
var redux_logger = __webpack_require__(17);
...
const core_logger = Object(redux_logger["createLogger"])({
  duration: true,
  collapsed: true,
  colors: {
    title: () => '#139BFE',
...
const core_sagaMiddleware = redux_saga_es();
const devtools = window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__;
const composeEnchancers =  false ? undefined : compose;
const middleware = [core_sagaMiddleware];
...
const store_store = createStore(rootReducer, enchancedStore);
core_sagaMiddleware.run(rootSaga);
...
var react_transition_group = __webpack_require__(9);

// EXTERNAL MODULE: ./source/components/Scheduler/styles.m.css
var styles_m = __webpack_require__(5);
...
function helpers_getDisplayName(WrappedComponent) {
...
const decorateSvg = ({
  ...
  withSvg.propTypes = {
    height: node_modules_prop_types["number"].isRequired,
    width: node_modules_prop_types["number"].isRequired
  };
  ...
  withSvg.displayName = `withSvg(${helpers_getDisplayName(Enhanceable)})`;
  return withSvg;
};
...
/* harmony default export */ var components_Task = (Task);
// EXTERNAL MODULE: ./source/components/Pagination/styles.m.css
var Pagination_styles_m = __webpack_require__(1);
var Pagination_styles_m_default = /*#__PURE__*/__webpack_require__.n(Pagination_styles_m);

// CONCATENATED MODULE: ./source/components/Pagination/index.js
// Core
...
const Pagination = () => {
  ...
  return react_default.a.createElement("div", {
    className: Pagination_styles_m_default.a.paginationWrapper
  }, react_default.a.createElement("button", {
    className: Pagination_styles_m_default.a.small,
    disabled: page === 1,
    onClick: () => goToPage(page - 1)
  }, "\u2190"), react_default.a.createElement("button", {
    className: page > 3 ? Pagination_styles_m_default.a.pagination : Pagination_styles_m_default.a.hidden,
    onClick: () => goToPage(1)
  }, 1), react_default.a.createElement("span", {
    className: page > 4 ? Pagination_styles_m_default.a.pagination : Pagination_styles_m_default.a.hidden
  }, "..."), react_default.a.createElement("button", {
    className: page > 2 ? Pagination_styles_m_default.a.pagination : Pagination_styles_m_default.a.hidden,
    onClick: () => goToPage(page - 2)
  }, page - 2), react_default.a.createElement("button", {
    className: page > 1 ? Pagination_styles_m_default.a.pagination : Pagination_styles_m_default.a.hidden,
    onClick: () => goToPage(page - 1)
  }, page - 1), react_default.a.createElement("span", {
    className: Pagination_styles_m_default.a.pagination
  }, page), react_default.a.createElement("button", {
    className: pageLast - page > 0 ? Pagination_styles_m_default.a.pagination : Pagination_styles_m_default.a.hidden,
    onClick: () => goToPage(page + 1)
  }, page + 1), react_default.a.createElement("button", {
    className: pageLast - page > 1 ? Pagination_styles_m_default.a.pagination : Pagination_styles_m_default.a.hidden,
    onClick: () => goToPage(page + 2)
  }, page + 2), react_default.a.createElement("span", {
    className: pageLast - page > 3 ? Pagination_styles_m_default.a.pagination : Pagination_styles_m_default.a.hidden
  }, "..."), react_default.a.createElement("button", {
    className: pageLast - page > 2 ? Pagination_styles_m_default.a.pagination : Pagination_styles_m_default.a.hidden,
    onClick: () => goToPage(pageLast)
  }, pageLast), react_default.a.createElement("button", {
    className: Pagination_styles_m_default.a.small,
...
const Scheduler = () => {
  ...
  const setAllCompleted = () => {
    if (todos.some(todo => !todo.get('completed'))) {
      dispatch(todosActions.updateTodoAsync(todos.map(todo => {
        return Scheduler_objectSpread({}, todo.toJSON(), {
          completed: true
        });
      })));
    }
  ...
  const todoList = react_default.a.createElement(react_transition_group["TransitionGroup"], null, todos.map((task, index) => react_default.a.createElement(react_transition_group["CSSTransition"], {
    classNames: "fade",
    key: index,
    timeout: 100
  }, react_default.a.createElement(components_Task, Scheduler_extends({
    className: styles_m_default.a.fadeenterdone,
  ...
  return react_default.a.createElement("section", {
    ...
    onClick: createTodo
  }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u0434\u0430\u0447\u0443")), react_default.a.createElement("div", {
    className: styles_m_default.a.overlay
  }, react_default.a.createElement("ul", null, todoList))), react_default.a.createElement("footer", null, react_default.a.createElement(assets_Checkbox, {
  ...
  }, "\u0412\u0441\u0435 \u0437\u0430\u0434\u0430\u0447\u0438 \u0432\u044B\u043F\u043E\u043B\u043D\u0435\u043D\u044B"), react_default.a.createElement(components_Pagination, null))));
};

/* harmony default export */ var components_Scheduler = (Scheduler);
// EXTERNAL MODULE: ./source/components/Spinner/styles.m.css
var Spinner_styles_m = __webpack_require__(19);
...
const App = () => {
  return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(components_Scheduler, null), react_default.a.createElement(components_Spinner, null));
};
...
Object(react_dom["render"])(react_default.a.createElement(components_Provider, {
  store: store_store
}, react_default.a.createElement(pages_App, null)), document.getElementById('app'));
